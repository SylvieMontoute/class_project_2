...
class ClientScreening(BaseModel, Base):
    ...
    unique_id: Mapped[str] = mapped_column(String(64), ForeignKey("client_profile.unique_id", onupdate="CASCADE",
                                                                  ondelete="CASCADE"))
...
class PartnerManagement(BaseModel, Base):
    ...
    updated_by: Mapped[str] = mapped_column(String(64), insert_default="system")
    unique_id: Mapped[str] = mapped_column(String(64), unique=True)
    partner_unique_id: Mapped[str] = mapped_column(String(64),
                                                   ForeignKey("client_profile.unique_id", onupdate="CASCADE",
                                                              ondelete="CASCADE"))
